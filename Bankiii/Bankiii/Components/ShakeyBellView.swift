...
//  Bankiii
//
//  Created by Johel Zarco on 01/06/22.
//
...
extension ShakeyBellView {
    ...
    func style() {
        ...
        buttonView.setTitle("3", for: .normal)
    ...
    func layout() {
        ...
        buttonView.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: -8).isActive = true
        ...
        UIView.animateKeyframes(withDuration: duration, delay: 0, options: [],
          animations: {
            ...
            UIView.addKeyframe(withRelativeStartTime: frameDuration*5, relativeDuration: frameDuration) {
                self.imageView.transform = CGAffineTransform.identity // go back to the original
            }
          },
          completion: nil
        )
